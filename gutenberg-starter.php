...
final Class Gutenberg_Starter {
    /**
     * plugin version
     */
    const GUTENBERG_STARTER_VERSION = "1.0";
    /**
    ...
    private function __construct(){
       ...
       add_action('plugins_loaded', [ $this, 'load_plugin_resources' ] );
    }
    /**
    ...
    public function activate(){
        if( ! get_option('gutenberg_starter_installed') ){
            update_option('gutenberg_starter_installed', time());
        }
        update_option('gutenberg_starter_version', GUTENBERG_STARTER_VERSION);
    }
    /**
 ...
 */
function gutenberg_starter(){
    return gutenberg_Starter::init();
}
/**
