...
function edit(props) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    attributes.fetchedMovies.length < 1 && (0,_components_APIResponsePromise__WEBPACK_IMPORTED_MODULE_8__["default"])('https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1').then(res => {
      /**
