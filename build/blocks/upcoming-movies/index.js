...
/* harmony import */ var _sidebarControl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sidebarControl */ "./src/blocks/upcoming-movies/sidebarControl.js");
...
function edit(props) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    attributes.fetchedMovies.length < 1 && GetAPIResponseFromUrl('https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1').then(res => {
      console.log('res', res);
      /**
